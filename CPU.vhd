...
--=====================================================================================================
		...
		-- ULA --
		ULAFINAL: ULA PORT MAP(ULACODE, BA_OUT, BB_OUT, ULA_ENABLE, ULA_OUT, OVERFLOW, e, g, l); 
...
--===============================================================================		
					...
					WHEN ULA5 =>
						 -- Habilita buffer G -> CBUS
						 ENG <= '1';

						 -- Escreve o resultado no registrador G
						 W4 <= '1';
